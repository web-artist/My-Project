                ...
                <div id="product_list" class=" right-side-blck">
                    ...
                    <ul class="catalog-list products">
						...
						<div class="loader" style="display:none;text-align:center">
							<img src="https://alor.com/wp-content/uploads/product-loading.gif" height="" width="">
						</div>
						<div class="no-more-product" style="display:none" id="<?php echo $my_need; ?>">No More Product</div>
					</div>
                </div>
            </div>
        </div>
...
?>
<?php if ($my_need == "https://alor.com/shop") { } else {?>
<script>
jQuery(function($){
