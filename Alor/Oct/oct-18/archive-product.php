                ...
                <div id="product_list" class=" right-side-blck">
                    <ul class="catalog-list products">
                        ...
                        while (have_posts()) : the_post(); ?>
                            ...
                            <?php $_GET['flag_first_item'] = $_GET['flag_first_item'] + 1; endwhile; // end of the loop. 
                        ?>
						<div  class="load-more-post div-height" style="display:none;"><?php $prdcat_id= $wp_query->get_queried_object()->term_id;$term_slug = get_term_by('id', $prdcat_id, 'product_cat', 'ARRAY_A');?><input type="hidden" id="cat_id" data-tax-terms="<?php echo $term_slug['slug'];?>" value="<?php echo $prdcat_id ;?>"/></div>
						<div style="clear:both"></div>
                    </ul>
