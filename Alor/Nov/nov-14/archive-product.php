...
//}
 ...
 if(color_price_attr == "product_cat") {
	 ...
	 if(filter_attr == "" ) {
			...
			$(document).ready(function() {
				...
				cat_id:cat_id
					...
					//$(" .pro-filter li").remove();					
					//$(".catalog-list.products.pro-filter li:nth-child(-n+9)").hide();
					$(".load-more-post").before(posts);					
...
jQuery(function($){
	...
	if(hw_page_url == "https://alor.com/product-tag/newdesigns"){
		$(".loader").hide();
	}
	else {
