            ...
            <div class="catalog  scroll_parent_wrap7">
                ...
                <div id="product_list" class=" right-side-blck">
                	...
                	<div class="visible-lg">
	                    <a href="https://alor.com/black-friday-giveaway/"><img src="https://alor.com/wp-content/uploads/win-banner.jpg" class="img-responsive" /></a>
                    </div>
                	<div class="visible-xs" style="margin:0 auto">
	                    <a href="https://alor.com/black-friday-giveaway/"><img src="https://alor.com/wp-content/uploads/win-banner-mobile.jpg" class="img-responsive" /></a>
                    </div>
                        ...
                        while (have_posts()) : the_post(); ?>
                            ...
                            <?php if ($cat_page_url == "https://alor.com/product-tag/newdesigns") {}
...
jQuery(function($){
	...
	var cat_total_product = $("#cat_id").attr("data-total-product");
	var hw_page_url = $("#hw_page_url").val();
	var explode_hw_url = $("#explode_hw_url").val();
